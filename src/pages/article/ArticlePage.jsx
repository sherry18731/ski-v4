...
function ArticlePage() {
  ...
  <div className="container">
    <img className="w-100 object-fit-cover object-position-center" src="https://images.unsplash.com/photo-1548784806-b9b21e8d740f?q=80&w=2932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="滑雪照片" style={{height:"450px"}}/>
    <div className="row flex-column align-items-center mt-5 mb-xxl">
